  ...
  return (
    <div
      ...
      style={{
        ...
        border: isOver ? '1px dashed rgb(242, 242, 242)' : '',
      }}
    >
      {isSlotWithItem(item) && (
        <div
        ...
        >
          ...
          >
            ...
            <div className="item-slot-info-wrapper">
              <span className="item-slot-info-left">
                {item.weight > 0
                  ? item.weight >= 1000
              ...
              <span className="item-slot-info-right">{item.count ? `x` + item.count.toLocaleString('en-us') : ''}</span>
            </div>
          </div>
          <div>
